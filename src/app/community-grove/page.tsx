...
const users = [
  { name: "0xAlice", state: "bloomed", age: 256 },
  { name: "0xBob", state: "growing", age: 128 },
  { name: "0xCharlie", state: "wilting", age: 90 },
  { name: "0xDave", state: "growing", age: 150 },
  { name: "0xEve", state: "sprout", age: 5 },
  { name: "0xFiona", state: "bloomed", age: 312 },
  { name: "0xGeorge", state: "growing", age: 78 },
  { name: "0xHeidi", state: "bloomed", age: 500 },
];
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {users.map(user => (
          <Card key={user.name} className="glass text-center">
            <CardHeader>
